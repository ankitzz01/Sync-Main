...
exports.default = new index_js_1.Event({
    ...
    async execute(interaction, client) {
        ...
        if (command.voteOnly && !(await new sdk_1.Api(client.data.topgg.token).hasVoted(interaction.user.id)))
            return (0, index_js_1.reply)(interaction, "❌", `You must vote me on [top.gg](${client.data.topgg.vote}) to use this command`);
